  ...
  <div class="bottomControl">
    ...
    <div class="left">
      ...
      <div class="downloadContainer"
           v-if="musicDetail.name">
        <i class="iconfont icon-download"
           @click="downloadCurrentMusic"></i>
      </div>
    </div>
    <!-- 中间 -->
    <div class="center">
      <div class="buttons">
        <span @click="playType = playType == 'order' ? 'random' : 'order'"><i class="iconfont icon-xunhuan"
             v-if="playType == 'order'"></i><i class="iconfont icon-suiji1"
             v-else></i></span>
    ...
    <div class="right">
      ...
      <el-tooltip class="item"
                  ...
                  placement="left"
                  :enterable="false">
        <div v-html="recondInfo"
             slot="content"></div>
        <el-link type="info"
                 href="https://beian.miit.gov.cn/"
                 target="_blank"
                 class="recondInfo">皖ICP备2021068014号</el-link>
      </el-tooltip>
    </div>
    <!-- 抽屉 -->
